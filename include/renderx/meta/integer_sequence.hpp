...
namespace xns {
	...
	class integer_sequence final {
		...
		static_assert(std::is_integral_v<T>, "integer_sequence: T must be an integral type");
	...
	using index_sequence = xns::integer_sequence<rx::size_t, N...>;
	...
	template <rx::size_t N>
	using make_index_sequence   = make_integer_sequence<rx::size_t, N>;

	/* alias to make an index sequence starting from B and ending at E */
	template <rx::size_t B, rx::size_t E>
	using make_index_range      = make_integer_range<size_t, B, E>;


	/* alias to make an index range with a step */
	template <rx::size_t B, rx::size_t E, rx::size_t S>
	using make_index_range_step = typename impl::make_integer_sequence<rx::size_t, B, E, S>::type;
